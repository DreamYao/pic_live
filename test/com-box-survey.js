...
define("getSurveyHtml", ["req_data_type", "showResult", "action", "jquery#1.8.1"], function (req_data_type, showResult, init_event, $) {
    ...
    function pageDom(showLimit, url) {
        ...
        //标题行
        var html_title = "<div class=\"surTit clearfix\"><div class=\"p_num\"><span class=\"status\"><\/span><em><\/em>人参与<\/div><div class=\"p_logo\"><img src=\"http://p0.ifengimg.com/fe/com-survey/images/cSur_icon1_b13bf0cb.png\"><span>凤凰公测<\/span><\/div><h2><a target=\"_blank\"><\/a><\/h2><\/div>";
        //问题表单
